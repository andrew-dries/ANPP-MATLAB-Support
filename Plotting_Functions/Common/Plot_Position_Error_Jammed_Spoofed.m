function dist_err = Plot_Position_Error_Jammed_Spoofed(log_data, plot_options)
...
%performance.
    ...
    %Make input vectors
    times                   = [];
    times.time1             = time(time ~= 0) - log_data.state.utc_time_min;
    
    input_vectors           = [];
    input_vectors.inp1      = pos_error(time ~= 0);
